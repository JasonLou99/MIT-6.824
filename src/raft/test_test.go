...
func TestBasicAgree2B(t *testing.T) {
	...
	DPrintf("Test (2B): TestBasicAgree2B========================")
...
func TestRPCBytes2B(t *testing.T) {
	...
	DPrintf("Test (2B): TestRPCBytes2B========================")
...
func TestFailAgree2B(t *testing.T) {
	...
	DPrintf("Test (2B): TestFailAgree2B========================")
...
func TestFailNoAgree2B(t *testing.T) {
	...
	DPrintf("Test (2B): TestFailNoAgree2B========================")
	...
	DPrintf("majority repair")
	// the disconnected majority may have chosen a leader from
	// among their own ranks, forgetting index 2.
	// 新的leader可能没有index 2的日志
	leader2 := cfg.checkOneLeader()
	// 对新的leader发送index为3的日志
...
func TestConcurrentStarts2B(t *testing.T) {
	...
	DPrintf("Test (2B): TestConcurrentStarts2B========================")
...
//
/*
测试图8所示的扩展raft paper的场景。每次迭代都会请求leader(如果有leader的话)在Raft日志中插入一条命令。
如果有一个leader，这个leader将以很高的概率快速失败(也许没有提交命令)，
或者在一段时间后以低概率崩溃(提交命令)。如果活服务器的数量不足以组成一个大多数，
也许可以启动一个新的服务器。新term的leader可能会尝试完成尚未提交的日志条目的复制。
*/
